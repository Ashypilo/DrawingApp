package com.ashypilov.drawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    private fun requestStoragePermission() {
        ...
        ActivityCompat.requestPermissions(this,
            arrayOf(android.Manifest.permission.READ_EXTERNAL_STORAGE, android.Manifest.permission.WRITE_EXTERNAL_STORAGE), STORAGE_PERMISSION_CODE)
    }
